...
export const API_INDEX = {
  ...
  resources: [
    ...
    'GET    /v1/verification-requests/{id}/documents',
    'POST   /v1/verification-requests/{id}/documents/{documentId}',
    'POST   /v1/verification-requests/{id}/documents/{documentId}/review',
